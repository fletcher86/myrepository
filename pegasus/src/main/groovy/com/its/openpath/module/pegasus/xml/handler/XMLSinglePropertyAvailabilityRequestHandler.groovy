...
import com.its.openpath.module.pegasus.xml.builder.XMLSinglePropertyAvailabilityMessageBuilder
...
/**
 * <code>XMLSinglePropertyAvailabilityRequestHandler</code>
 * <p/>
 * Handles Single Property Availability Service Requests from the Pegasus USW.
 * <p />
...
@Service
@ManagedResource('OPENPATH:name=/module/pegasus/xml/XMLSinglePropertyAvailabilityRequestHandler')
class XMLSinglePropertyAvailabilityRequestHandler
extends AbstractXMLHandler
{
  private static final Logger sLogger = LoggerFactory.getLogger( XMLSinglePropertyAvailabilityRequestHandler.class.name )

  @Autowired(required = true)
  protected XMLSinglePropertyAvailabilityMessageBuilder mMessageBuilder


  /**
   * Constructor
   */
  XMLSinglePropertyAvailabilityRequestHandler( )
  {
  ...
  def void process( )
  {
    ...
    StatisticsDashboard.singlePropertyAvailabilityRequestCount.andIncrement
    ...
    opsReqMessage.messageType = RoomAvailabilitySearchType.SINGLE_PROPERTY.number
