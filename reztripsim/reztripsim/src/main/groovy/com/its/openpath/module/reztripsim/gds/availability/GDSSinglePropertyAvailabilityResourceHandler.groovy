...
class GDSSinglePropertyAvailabilityResourceHandler
{
  ...
  private String createOpenPathJSONResponse( AvailabilityRequest requestObjJSON )
  {
    ...
    try
    {
      ...
      // Flip this to 'NoAvailability' to test 'no availability' responses to USW
      roomStay.availabilityStatus = "AvailableForSale"
      // Flip this to 'true' to test 'alternate availability' responses to USW
      ...
      room.description1 = "Superior King Room1"
      room.description2 = "Superior King Room2"
      room.description3 = "Superior King Room3"
      ...
      ratePlan.descriptionList = descriptionList
      descriptionList << "Awesome rate plan description1"
      descriptionList << "Awesome rate plan description2"
      descriptionList << "Awesome rate plan description3"
      ...
      List<String> promotionalTextList = []
      ratePlan.promotionalTextList = promotionalTextList
      promotionalTextList << "Great savings available for weekend breaks during the summer - text1"
      promotionalTextList << "Great savings available for weekend breaks during the summer - text2"
      promotionalTextList << "Great savings available for weekend breaks during the summer - text3"
