...
@Service("NotifReportRequestErrorsEventXMLPersistenceHandler")
@ManagedResource('OPENPATH:name=/module/opscommon/event/persistence/NotifReportRequestErrorsEventXMLPersistenceHandler')
class NotifReportRequestErrorsEventXMLPersistenceHandler extends AbstractEventPersistenceHandler
{
  private static Logger sLogger = LoggerFactory.getLogger(NotifReportRequestErrorsEventXMLPersistenceHandler.getName())
  
  /**
   * Constructor
   */
  NotifReportRequestErrorsEventXMLPersistenceHandler()
  {
  ...
  {
    super.init()
    super.mOpsMessageBus.consumeFromQueue( PersistenceMessageBusQueueNames.RESERVATIONS_NOTIFICATION_REPORT_XML_ERRORS_REQUEST, this, false )
  }
  ...
  throws RuntimeException
  {
    ...
    this.persistPayload ( uuid, "notifreportrequesterrorsxml", payload?payload.bytes: "".getBytes () )
