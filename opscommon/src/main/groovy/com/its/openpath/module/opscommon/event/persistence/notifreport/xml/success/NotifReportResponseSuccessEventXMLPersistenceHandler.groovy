...
@Service("NotifReportResponseSuccessEventXMLPersistenceHandler")
@ManagedResource('OPENPATH:name=/module/opscommon/event/persistence/NotifReportResponseSuccessEventXMLPersistenceHandler')
class NotifReportResponseSuccessEventXMLPersistenceHandler extends AbstractEventPersistenceHandler
{
  private static Logger sLogger = LoggerFactory.getLogger(NotifReportResponseSuccessEventXMLPersistenceHandler.getName())
  
  /**
   * Constructor
   */
  NotifReportResponseSuccessEventXMLPersistenceHandler()
  {
  ...
  {
    super.init()
    super.mOpsMessageBus.consumeFromQueue( PersistenceMessageBusQueueNames.RESERVATIONS_NOTIFICATION_REPORT_XML_SUCCESS_RESPONSE, this, false )
  }
  ...
  throws RuntimeException
  {
    ...
    this.persistPayload ( uuid, "notifreportresponsesuccessxml", payload?payload.bytes: "".getBytes () )
