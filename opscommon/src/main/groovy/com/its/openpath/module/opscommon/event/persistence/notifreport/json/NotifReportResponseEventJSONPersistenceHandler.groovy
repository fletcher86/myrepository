...
@Service("NotifReportResponseEventJSONPersistenceHandler")
@ManagedResource('OPENPATH:name=/module/opscommon/event/persistence/NotifReportResponseEventJSONPersistenceHandler')
class NotifReportResponseEventJSONPersistenceHandler extends AbstractEventPersistenceHandler
{
  private static Logger sLogger = LoggerFactory.getLogger(NotifReportResponseEventJSONPersistenceHandler.getName())
  
  /**
   * Constructor
   */
  NotifReportResponseEventJSONPersistenceHandler()
  {
  ...
  {
    super.init()
    super.mOpsMessageBus.consumeFromQueue( PersistenceMessageBusQueueNames.RESERVATIONS_NOTIFICATION_REPORT_JSON_RESPONSE, this, false )
  }
  ...
  throws RuntimeException
  {
    ...
    this.persistPayload ( uuid, "notifreportresponsejson", payload?payload.bytes: "".getBytes () )
