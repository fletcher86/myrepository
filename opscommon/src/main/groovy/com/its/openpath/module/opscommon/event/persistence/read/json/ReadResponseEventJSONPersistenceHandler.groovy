...
@Service("ReadResponseEventJSONPersistenceHandler")
@ManagedResource('OPENPATH:name=/module/opscommon/event/persistence/ReadResponseEventJSONPersistenceHandler')
class ReadResponseEventJSONPersistenceHandler extends AbstractEventPersistenceHandler
{
  private static Logger sLogger = LoggerFactory.getLogger(ReadResponseEventJSONPersistenceHandler.getName())
 
  /**
   * Constructor
   */
  ReadResponseEventJSONPersistenceHandler()
  {
  ...
  {
    super.init()
    super.mOpsMessageBus.consumeFromQueue( PersistenceMessageBusQueueNames.READ_RESPONSE_JSON_QUEUE, this, false )
  }
  ...
  throws RuntimeException
  {
     ...
     */
    this.persistPayload ( uuid, "readresponsejson", payload?payload.bytes: "".getBytes ())
  }
