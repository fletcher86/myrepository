...
class ReservationsConfirmationRequestHandler
{
  private static final Logger sLogger = LoggerFactory.getLogger( ReservationsConfirmationRequestHandler.class.name )
  
  /**
   * Constructor
   */
  ReservationsConfirmationRequestHandler( )
  {
